...
class PingpongSorter:
    ...
    def read_colors(self):
        ...
        return r, g, b
        # return color[0], color[1], color[2]  # R, G, B
    ...
    def is_no_pingpong(self, r, g, b):
        """Check if no pingpong is detected (condition for LED3)"""
        ...
        try:
            while True:
                ...
                if self.state == "Idle":
                    ...
                    # Implement exact condition from state machine
                    ...
                    if self.is_no_pingpong(r, g, b):
                        ...
                        if self.is_orange_pingpong(r, g, b):
                            ...
                            self.set_servo_angle(servo2, 45)  # Open Gate2 for orange
                            ...
                            self.set_servo_angle(servo2, -45)  # Open Gate2 for white
                            GPIO.output(LED3_PIN, 0)  # LED3 OFF
                    ...
                    if self.counter >= 3 and self.is_no_pingpong(r, g, b):
                        self.set_servo_angle(servo2, 0)  # Close Gate2
